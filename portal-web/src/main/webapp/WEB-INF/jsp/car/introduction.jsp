    ...
    <div class="nav-table">
        ...
        <div class="nav-cont">
            <ul>
                ...
                <li class="qc"><a href="#">限时抢</a></li>WEB-INF/jsp/include/style.jsp
        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="http://192.168.13.130/01.jpg"><img src="http://192.168.13.130/01.jpg" alt="细节展示放大镜特效" rel="http://192.168.13.130/01.jpg" class="jqzoom" /></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="http://192.168.13.130/01_small.jpg" mid="http://192.168.13.130/01_small.jpg" big="http://192.168.13.130/01_small.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
