...
<%--
  Creator by Tidetrace on 2017/11/10 17:18
  Description：加入购物车页面
--%>
...
<head>
    ...
    <title>商品页面</title>
    <jsp:include page="/WEB-INF/jsp/includes/style.jsp"/>
    <jsp:include page="/WEB-INF/jsp/includes/script.jsp"/>
</head>
<body>
        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="${goods.goodImg}"><img src="${goods.goodImg}" alt="细节展示放大镜特效" rel="${goods.goodImg}"
                                                    class="jqzoom"/></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${goods.goodImg}" mid="${goods.goodImg}" big="${goods.goodImg}"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${goods.goodMidImg}" mid="${goods.goodMidImg}"
                                             big="${goods.goodMidImg}"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${goods.goodBigImg}" mid="${goods.goodBigImg}"
                                             big="${goods.goodBigImg}"></a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price">${goods.goodSales}</b></dd>
                    </li>
                    <li class="price iteminfo_mktprice">
                        <dt>原价</dt>
                        <dd><em>¥</em><b class="sys_item_mktprice">${goods.goodPrice}</b></dd>
                    </li>
                    <div class="clear"></div>
                </div>
                    ...
                    <div class="iteminfo_freprice">
                        <div class="am-form-content address">
                            <select data-am-selected>
                                ...
                                <option value="b">河南市</option>
                                <option value="b">广州省</option>
                                <option value="b">湖南省</option>
                                <option value="b">福建省</option>
                            </select>
                            <select data-am-selected>
                        ...
                        <div class="pay-logis">
                            <b class="sys_item_freprice">快递${goods.expressFee}元</b>
                        </div>
                    </div>
                </dl>
                <div class="clear"></div>
                ...
                <dl class="iteminfo_parameter sys_item_specpara">
                            ...
                            <div class="theme-popbod dform">
                                <form class="theme-signin" name="loginform" action="" method="post">
                                    ...
                                    <div class="theme-signin-left">
                                        ...
                                        <c:forEach var="ss" items="${ss}" step="1" varStatus="i">
                                        <div class="theme-options">
                                            <div class="cart-title"> ${ss.trim().replace("\"","")} </div>
                                            <ul>
                    ...
                    <dd>
                        ...
                        <span id="Stock" class="tb-hidden">库存<span class="stock">${goods.goodNumber}</span>件</span>
                    </dd>
                ...
                <div class="am-tab-panel am-fade am-in am-active">
                    ...
                    <div class="details">
                        ...
                        <div class="twlistNews">
                            <img src="http://192.168.13.130/bws2.jpg"/>
...
<script>
    ...
    $('#LikBasket').click(function () {
        $.post('shoppingCart/addCart/${goods.goodUuid}.do', {
            // 传递的参数
            goodSales:$('.sys_item_price').text(),
            number:$('#text_box').val()
        }, function (data) {
            if (data.success) {
               alert("已经成功添加到购物车！")
                location.href="shoppingCart/show.do";
            } else {
                alert(data.mess);
            }
        },'json');
